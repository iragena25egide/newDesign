...
const AddVideoForm = ({ test = {}, onSave }) => {
  ...
  const handleFinish = (values) => {
    const uploadedFile = values.upload && values.upload[0]?.originFileObj;
  ...
  return (
    <div>
      <h2 className="text-xl font-bold mb-4">Add Video to {test?.title || "Untitled Test"}</h2>
